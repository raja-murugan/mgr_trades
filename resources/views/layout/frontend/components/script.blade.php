...
<script src="{{ asset('assets/frontend/vendors/sidebar-content/jquery-sidebar-content.js') }}"></script>

<script src="{{ asset('assets/frontend/vendors/tweenmax/TweenMax.min.js') }}"></script>
<!-- Template js -->
<script src="{{ asset('assets/frontend/js/endreox.js') }}"></script>
