...
<title>MGR Trades | Tiruchirappalli</title>
...
<link rel="stylesheet" href="{{ asset('assets/frontend/vendors/endreox-icons/style.css') }}">
...
<link rel="stylesheet" href="{{ asset('assets/frontend/vendors/free-hand-font/stylesheet.css') }}">

<!-- template styles -->
<link rel="stylesheet" href="{{ asset('assets/frontend/css/endreox.css') }}">
<link rel="stylesheet" href="{{ asset('assets/frontend/css/endreox-responsive.css') }}">
